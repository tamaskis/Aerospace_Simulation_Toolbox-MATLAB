%==========================================================================
%
% reverse_transform_rot_pos  Position transformation from a rotating frame
% to a stationary frame.
%
%   r_A = reverse_transform_mov_pos(r_B,R_A2B)
%
...
%
%==========================================================================
function r_A = reverse_transform_rot_pos(r_B,R_A2B)
    r_A = (R_A2B.')*r_B;
end