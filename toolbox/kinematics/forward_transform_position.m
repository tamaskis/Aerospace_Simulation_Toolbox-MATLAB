%==========================================================================
%
% forward_transform_position  Transformation of the position of a point
% from a stationary frame to a moving frame.
%
%   r_B2P_B = forward_transform_position(r_A2P_A,R_A2B,r_A2B_A)
%
...
%
%==========================================================================
function r_B2P_B = forward_transform_position(r_A2P_A,R_A2B,r_A2B_A)
